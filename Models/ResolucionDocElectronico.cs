...
{
    public partial class ResolucionDocElectronico
    {
        public ResolucionDocElectronico()
        {
            ConsecutivoFas = new HashSet<ConsecutivoFa>();
        }
        ...
        public virtual ICollection<ConsecutivoFa> ConsecutivoFas { get; set; }
    }
}
