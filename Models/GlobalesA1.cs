...
{
    public partial class GlobalesA1
    {
        ...
        public virtual Monedum1 MonedaDolarNavigation { get; set; } = null!;
        public virtual Monedum1 MonedaLocalNavigation { get; set; } = null!;
        public virtual Pai1 PaisLocalNavigation { get; set; } = null!;
        public virtual TipoCambio1 TipoCambioDolarNavigation { get; set; } = null!;
    }
}
