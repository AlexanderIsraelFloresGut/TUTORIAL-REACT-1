...
{
    public partial class EstrucProceso1
    {
        public EstrucProceso1()
        {
            EstrucMaterial1s = new HashSet<EstrucMaterial1>();
            ...
            ProcesoEnlace1s = new HashSet<ProcesoEnlace1>();
        }
        ...
        public virtual ProcesoAlterno1 ProcesoAlterno1 { get; set; } = null!;
        public virtual ICollection<EstrucMaterial1> EstrucMaterial1s { get; set; }
        ...
        public virtual ICollection<ProcesoEnlace1> ProcesoEnlace1s { get; set; }
    }
}
