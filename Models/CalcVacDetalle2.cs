...
{
    public partial class CalcVacDetalle2
    {
        ...
        public virtual EmpleadoAccPer2? AccionPersonalNavigation { get; set; }
        public virtual CalculoVacacional2 CalculoVacacionalNavigation { get; set; } = null!;
        public virtual ContribucionVac2 ContribucionVacNavigation { get; set; } = null!;
