...
{
    public partial class LiquidacGasto
    {
        ...
        public virtual Embarque? EmbarqueNavigation { get; set; }
        public virtual GastoCompra? GastoCompraNavigation { get; set; }
        public virtual LiquidacCompra LiquidacCompraNavigation { get; set; } = null!;
