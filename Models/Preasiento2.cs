...
{
    public partial class Preasiento2
    {
        public Preasiento2()
        {
            DetallePreasiento2s = new HashSet<DetallePreasiento2>();
        }
        ...
        public virtual ICollection<DetallePreasiento2> DetallePreasiento2s { get; set; }
    }
}
