...
{
    public partial class DetNomElect1
    {
        ...
        public string? PaisGen { get; set; }
        public string? DepartamentoGen { get; set; }
        public string? MunicipioGen { get; set; }
        ...
        public string? SegundoApellidoEmp { get; set; }
        public string? PrimerNombreEmp { get; set; }
        public string? OtrosNombresEmp { get; set; }
        public string? NitEmp { get; set; }
        public string? DvEmp { get; set; }
