...
{
    public partial class GlobalesAf
    {
        ...
        public virtual TipoAccionAf? AccionesCentroNavigation { get; set; }
        ...
        public virtual CuentaContable? CtaDeterioroNavigation { get; set; }
        public virtual CentroCosto? CtrAjuInflacNavigation { get; set; }
        public virtual CentroCosto? CtrDeterioroNavigation { get; set; }
