...
{
    public partial class DevolLinEmbarque
    {
        ...
        public virtual Devolucion DevolucionNavigation { get; set; } = null!;
        public virtual EmbarqueLinea EmbarqueNavigation { get; set; } = null!;
