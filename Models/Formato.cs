...
namespace TUTORIAL_REACT_1.Models
{
    public partial class Formato
    {
        public Formato()
        {
            FormatoColumnas = new HashSet<FormatoColumna>();
            FormatoOrdens = new HashSet<FormatoOrden>();
            FormatoUsuarios = new HashSet<FormatoUsuario>();
        }
        ...
        public virtual ICollection<FormatoColumna> FormatoColumnas { get; set; }
        public virtual ICollection<FormatoOrden> FormatoOrdens { get; set; }
        public virtual ICollection<FormatoUsuario> FormatoUsuarios { get; set; }
    }
}
