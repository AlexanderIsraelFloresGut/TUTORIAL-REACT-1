...
{
    public partial class ActivoHistReval
    {
        ...
        public virtual HistDepreciacion? ConsecDeprCNavigation { get; set; }
        public virtual HistDepreciacion? ConsecDeprFNavigation { get; set; }
