...
{
    public partial class ActivoHistReval2
    {
        ...
        public virtual HistDepreciacion2? ConsecDeprCNavigation { get; set; }
        public virtual HistDepreciacion2? ConsecDeprFNavigation { get; set; }
