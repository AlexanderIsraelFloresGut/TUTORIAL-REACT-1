...
{
    public partial class ArticuloCompra1
    {
        ...
        public virtual CodigoArancel1? CodigoArancelNavigation { get; set; }
        public virtual Impuesto1 ImpuestoNavigation { get; set; } = null!;
        public virtual Monedum1? UltMonedaNavigation { get; set; }
        public virtual Proveedor1? UltProveedorNavigation { get; set; }
    }
}
