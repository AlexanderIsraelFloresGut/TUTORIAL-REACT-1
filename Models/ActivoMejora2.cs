...
{
    public partial class ActivoMejora2
    {
        public ActivoMejora2()
        {
            ActivoDesmantelamiento2s = new HashSet<ActivoDesmantelamiento2>();
            ActivoHistReval2s = new HashSet<ActivoHistReval2>();
            DeprPorcentaje2s = new HashSet<DeprPorcentaje2>();
            HistDepreciacion2s = new HashSet<HistDepreciacion2>();
            HistDeterioro2s = new HashSet<HistDeterioro2>();
        ...
        public virtual ICollection<ActivoHistReval2> ActivoHistReval2s { get; set; }
        public virtual ICollection<DeprPorcentaje2> DeprPorcentaje2s { get; set; }
        public virtual ICollection<HistDepreciacion2> HistDepreciacion2s { get; set; }
        public virtual ICollection<HistDeterioro2> HistDeterioro2s { get; set; }
