...
{
    public partial class Preasiento
    {
        public Preasiento()
        {
            DetallePreasientos = new HashSet<DetallePreasiento>();
        }
        ...
        public virtual ICollection<DetallePreasiento> DetallePreasientos { get; set; }
    }
}
