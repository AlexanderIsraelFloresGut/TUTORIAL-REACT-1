...
{
    public partial class GlobalesCc
    {
        ...
        public virtual Impuesto? ImpuestoXOmisionNavigation { get; set; }
        public virtual Paquete? PaqueteCreNavigation { get; set; }
        public virtual Paquete? PaqueteDebNavigation { get; set; }
        public virtual TipoAsiento? TipoAsientoCreNavigation { get; set; }
        public virtual TipoAsiento? TipoAsientoDebNavigation { get; set; }
    }
}
