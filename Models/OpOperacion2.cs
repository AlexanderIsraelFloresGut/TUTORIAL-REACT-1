...
{
    public partial class OpOperacion2
    {
        public OpOperacion2()
        {
            ...
            OpOperEnlace2s = new HashSet<OpOperEnlace2>();
            OpOperProd2s = new HashSet<OpOperProd2>();
            OpOperVario2s = new HashSet<OpOperVario2>();
            OpOperacionMo2s = new HashSet<OpOperacionMo2>();
            OpOperacionRubro2s = new HashSet<OpOperacionRubro2>();
        }
        ...
        public virtual UnidadDeMedidum2? UnidProduccionPpNavigation { get; set; }
        ...
        public virtual ICollection<OpOperEnlace2> OpOperEnlace2s { get; set; }
        public virtual ICollection<OpOperProd2> OpOperProd2s { get; set; }
        public virtual ICollection<OpOperVario2> OpOperVario2s { get; set; }
        public virtual ICollection<OpOperacionMo2> OpOperacionMo2s { get; set; }
        public virtual ICollection<OpOperacionRubro2> OpOperacionRubro2s { get; set; }
    }
}
