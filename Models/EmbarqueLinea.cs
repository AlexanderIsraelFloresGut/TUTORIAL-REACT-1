...
{
    public partial class EmbarqueLinea
    {
        public EmbarqueLinea()
        {
        ...
        public short EmbarqueLinea1 { get; set; }
        ...
        public virtual DetDocumentoEmbarque? DetDocumentoEmbarque { get; set; }
        public virtual Embarque EmbarqueNavigation { get; set; } = null!;
        public virtual Monedum MonedaOcNavigation { get; set; } = null!;
        public virtual OrdenCompraLinea? OrdenCompraNavigation { get; set; }
