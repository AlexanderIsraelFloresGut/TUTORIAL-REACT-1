...
{
    public partial class GlobalesCg1
    {
        ...
        public virtual CuentaContable1? CtaCierreNavigation { get; set; }
        public virtual CentroCosto1? CtrCierreNavigation { get; set; }
        public virtual TipoAsiento1? TipAsntCierreAnNavigation { get; set; }
    }
}
