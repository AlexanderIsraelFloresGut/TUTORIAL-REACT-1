...
{
    public partial class GlobalesPc1
    {
        ...
        public virtual ConsecutivoCi1? ConsecConsumoNavigation { get; set; }
        public virtual ConsecutivoCi1? ConsecProducNavigation { get; set; }
