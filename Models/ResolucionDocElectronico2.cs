...
{
    public partial class ResolucionDocElectronico2
    {
        public ResolucionDocElectronico2()
        {
            ConsecutivoFa2s = new HashSet<ConsecutivoFa2>();
        }
        ...
        public virtual ICollection<ConsecutivoFa2> ConsecutivoFa2s { get; set; }
    }
}
