...
{
    public partial class Diferido1
    {
        public Diferido1()
        {
            DiferidoDocCc1s = new HashSet<DiferidoDocCc1>();
            DiferidoDocCp1s = new HashSet<DiferidoDocCp1>();
        ...
        public virtual CentroCuentum1 Ct1 { get; set; } = null!;
        public virtual CentroCuentum1 Ct2 { get; set; } = null!;
        public virtual CentroCuentum1 CtNavigation { get; set; } = null!;
        ...
        public virtual ICollection<DiferidoDocCp1> DiferidoDocCp1s { get; set; }
