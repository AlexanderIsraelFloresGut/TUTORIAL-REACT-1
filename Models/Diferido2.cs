...
{
    public partial class Diferido2
    {
        public Diferido2()
        {
            DiferidoDocCc2s = new HashSet<DiferidoDocCc2>();
            DiferidoDocCp2s = new HashSet<DiferidoDocCp2>();
        ...
        public virtual CentroCuentum2 Ct { get; set; } = null!;
        public virtual CentroCuentum2 Ct1 { get; set; } = null!;
        public virtual CentroCuentum2 Ct2 { get; set; } = null!;
        public virtual CentroCuentum2 CtNavigation { get; set; } = null!;
        ...
        public virtual ICollection<DiferidoDocCp2> DiferidoDocCp2s { get; set; }
