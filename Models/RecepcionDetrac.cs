...
{
    public partial class RecepcionDetrac
    {
        ...
        public virtual DocumentosCp DocumentosCpNavigation { get; set; } = null!;
        public virtual Proveedor ProveedorNavigation { get; set; } = null!;
        public virtual TiposDetraccione TiposDetraccione { get; set; } = null!;
    }
}
