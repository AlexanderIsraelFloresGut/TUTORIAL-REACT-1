...
{
    public partial class OrdenProduccion1
    {
        public OrdenProduccion1()
        {
            OpOperacion1s = new HashSet<OpOperacion1>();
            OrdenCliente1s = new HashSet<OrdenCliente1>();
            OrdenViewit1s = new HashSet<OrdenViewit1>();
            PedidoOrdenProduc1s = new HashSet<PedidoOrdenProduc1>();
            Requisicion1s = new HashSet<Requisicion1>();
        }
        ...
        public virtual Bodega1 BodegaMpNavigation { get; set; } = null!;
        public virtual Bodega1 BodegaPtNavigation { get; set; } = null!;
        ...
        public virtual OrdenMensaje1 OrdenMensaje1 { get; set; } = null!;
        public virtual OrdenNota1 OrdenNota1 { get; set; } = null!;
        ...
        public virtual ICollection<OrdenViewit1> OrdenViewit1s { get; set; }
        public virtual ICollection<PedidoOrdenProduc1> PedidoOrdenProduc1s { get; set; }
        public virtual ICollection<Requisicion1> Requisicion1s { get; set; }
    }
}
