...
{
    public partial class GlobalesCg2
    {
        ...
        public virtual CuentaContable2? CtaCierreNavigation { get; set; }
        public virtual CentroCosto2? CtrCierreNavigation { get; set; }
        public virtual TipoAsiento2? TipAsntCierreAnNavigation { get; set; }
    }
}
