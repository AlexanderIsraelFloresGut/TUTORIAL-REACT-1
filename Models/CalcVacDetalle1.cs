...
{
    public partial class CalcVacDetalle1
    {
        ...
        public virtual EmpleadoAccPer1? AccionPersonalNavigation { get; set; }
        public virtual CalculoVacacional1 CalculoVacacionalNavigation { get; set; } = null!;
