...
{
    public partial class ActivoMejora1
    {
        public ActivoMejora1()
        {
            ActivoDesmantelamiento1s = new HashSet<ActivoDesmantelamiento1>();
            ActivoHistReval1s = new HashSet<ActivoHistReval1>();
            DeprPorcentaje1s = new HashSet<DeprPorcentaje1>();
            Equipo1s = new HashSet<Equipo1>();
            HistDepreciacion1s = new HashSet<HistDepreciacion1>();
            HistDeterioro1s = new HashSet<HistDeterioro1>();
        ...
        public virtual ICollection<ActivoHistReval1> ActivoHistReval1s { get; set; }
        public virtual ICollection<DeprPorcentaje1> DeprPorcentaje1s { get; set; }
        public virtual ICollection<Equipo1> Equipo1s { get; set; }
        public virtual ICollection<HistDepreciacion1> HistDepreciacion1s { get; set; }
        public virtual ICollection<HistDeterioro1> HistDeterioro1s { get; set; }
