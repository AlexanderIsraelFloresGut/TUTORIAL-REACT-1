...
{
    public partial class GlobalesRh
    {
        ...
        public virtual EstadoEmpleado? EstadoEmpContNavigation { get; set; }
        public virtual EstadoEmpleado? EstadoEmpLiqNavigation { get; set; }
        public virtual Paquete? PaqueteNavigation { get; set; }
        public virtual TipoAccion? TipoAccAcumAdicNavigation { get; set; }
        public virtual TipoAccion? TipoAccIncAcumNavigation { get; set; }
        public virtual TipoAccion? TipoAccIncDismNavigation { get; set; }
        public virtual TipoAccion? TipoAccPagAdicNavigation { get; set; }
        public virtual TipoAccion? TipoAccionAcumNavigation { get; set; }
        public virtual TipoAccion? TipoAccionContNavigation { get; set; }
        public virtual TipoAccion? TipoAccionLiqNavigation { get; set; }
        public virtual TipoAccion? TipoAccionPagoNavigation { get; set; }
        public virtual TipoAsiento? TipoAsientoNavigation { get; set; }
        public virtual TipoAusencium? TipoAusPagAdicNavigation { get; set; }
        public virtual TipoAusencium? TipoAusenciaPagoNavigation { get; set; }
    }
}
