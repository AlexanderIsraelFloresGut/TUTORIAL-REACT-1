...
{
    public partial class NcfConsecutivo2
    {
        public NcfConsecutivo2()
        {
            NcfConsecutivoUsuario2s = new HashSet<NcfConsecutivoUsuario2>();
        }
        ...
        public virtual ICollection<NcfConsecutivoUsuario2> NcfConsecutivoUsuario2s { get; set; }
    }
}
