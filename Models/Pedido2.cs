...
namespace TUTORIAL_REACT_1.Models
{
    public partial class Pedido2
    {
        public Pedido2()
        {
            FiadoresPedFa2s = new HashSet<FiadoresPedFa2>();
            ...
            PlanPagoPed2s = new HashSet<PlanPagoPed2>();
        }
        ...
        public virtual CancelacionCotizacione2? RazonCancelaCotiNavigation { get; set; }
        ...
        public virtual MonedaPedBackord2 MonedaPedBackord2 { get; set; } = null!;
        public virtual ICollection<FiadoresPedFa2> FiadoresPedFa2s { get; set; }
        ...
        public virtual ICollection<PlanPagoPed2> PlanPagoPed2s { get; set; }
    }
}
