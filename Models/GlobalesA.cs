...
{
    public partial class GlobalesA
    {
        ...
        public virtual Monedum MonedaDolarNavigation { get; set; } = null!;
        public virtual Monedum MonedaLocalNavigation { get; set; } = null!;
        public virtual Pai PaisLocalNavigation { get; set; } = null!;
        public virtual TipoCambio TipoCambioDolarNavigation { get; set; } = null!;
    }
}
