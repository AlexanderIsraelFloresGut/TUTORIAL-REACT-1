...
namespace TUTORIAL_REACT_1.Models
{
    public partial class Formato1
    {
        public Formato1()
        {
            FormatoColumna1s = new HashSet<FormatoColumna1>();
            FormatoOrden1s = new HashSet<FormatoOrden1>();
            FormatoUsuario1s = new HashSet<FormatoUsuario1>();
        }
        ...
        public virtual ICollection<FormatoColumna1> FormatoColumna1s { get; set; }
        public virtual ICollection<FormatoOrden1> FormatoOrden1s { get; set; }
        public virtual ICollection<FormatoUsuario1> FormatoUsuario1s { get; set; }
    }
}
