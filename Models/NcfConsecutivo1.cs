...
{
    public partial class NcfConsecutivo1
    {
        public NcfConsecutivo1()
        {
            NcfConsecutivoUsuario1s = new HashSet<NcfConsecutivoUsuario1>();
        }
        ...
        public virtual ICollection<NcfConsecutivoUsuario1> NcfConsecutivoUsuario1s { get; set; }
    }
}
