...
{
    public partial class OpOperacion1
    {
        public OpOperacion1()
        {
            OpOperConsumo1s = new HashSet<OpOperConsumo1>();
            OpOperContLiq1s = new HashSet<OpOperContLiq1>();
            OpOperCostAux1s = new HashSet<OpOperCostAux1>();
            OpOperDet1s = new HashSet<OpOperDet1>();
            OpOperEnlace1s = new HashSet<OpOperEnlace1>();
            OpOperProd1s = new HashSet<OpOperProd1>();
            OpOperVario1s = new HashSet<OpOperVario1>();
        ...
        public virtual Equipo1? EquipoSimulacionNavigation { get; set; }
        public virtual OrdenProduccion1 OrdenProduccionNavigation { get; set; } = null!;
        public virtual UnidadDeMedidum1? UnidProduccionPpNavigation { get; set; }
        public virtual ICollection<OpOperConsumo1> OpOperConsumo1s { get; set; }
        public virtual ICollection<OpOperContLiq1> OpOperContLiq1s { get; set; }
        public virtual ICollection<OpOperCostAux1> OpOperCostAux1s { get; set; }
        public virtual ICollection<OpOperDet1> OpOperDet1s { get; set; }
        public virtual ICollection<OpOperEnlace1> OpOperEnlace1s { get; set; }
        public virtual ICollection<OpOperProd1> OpOperProd1s { get; set; }
        public virtual ICollection<OpOperVario1> OpOperVario1s { get; set; }
